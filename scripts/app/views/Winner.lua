...
function Winner:ctor(winner)
	...
	self.modalLayer:addContentChild(gongxiLabel, display.cx - modalOffsetX, display.cy, display.LEFT_CENTER)
	...
	self.modalLayer:addContentChild(otherLabel, display.cx + modalOffsetX, display.cy, display.RIGHT_CENTER)

	self:addChild(self.modalLayer:getView())
	self.modalLayer:addEventListener("onBackgroudTap", hander(self,self.onClose))
end
